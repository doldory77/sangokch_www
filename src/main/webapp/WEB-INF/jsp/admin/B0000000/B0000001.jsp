  ...
  <body>
  	<div>
		<div class="admin-header fs-3 d-flex justify-content-between align-content-end p-2">
		    ...
		    <span class="py-1 align-self-baseline">산곡교회비전</span>
		...
		<div class="mb-2 ps-2 py-1">
			<span onclick="javascript:location.href='/admin/main.do'">홈페이지 관리 홈</span><span>&nbsp;&gt;&nbsp;</span><span>교회소개 관리(산곡교회비전)</span>
		</div>
	</div>   
